...
public class OpenClozeQuestion extends WrittenAnswer implements View.OnClickListener {
    private static final String TAG = "OpenClozeQuestion";
     ...
     */
    public static OpenClozeQuestion newInstance(int packageId) {
        OpenClozeQuestion fragment = new OpenClozeQuestion();
...
//        startTimer();
        ...
        viewModel.getOpenClozeQuestionLiveData(packageId).observe(getViewLifecycleOwner(), openCloze -> {
