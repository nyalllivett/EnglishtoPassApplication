...
public class ListeningOneSituationQuestion extends ModelUoeParent {
    ...
    public ListeningOneSituationQuestion(@NonNull String title, @NonNull String questionBody) {
        super(title);
