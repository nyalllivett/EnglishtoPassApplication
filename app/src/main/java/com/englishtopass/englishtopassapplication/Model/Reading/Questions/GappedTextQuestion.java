...
public class GappedTextQuestion extends ReadingParent {
    ...
    public GappedTextQuestion(String title, int reading_id, String body) {
        super(title);
